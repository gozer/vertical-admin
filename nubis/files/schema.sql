...
CREATE PROJECTION public.mysql_database /*+createtype(L)*/ 
(
 mysql_host_id,
 database_date,
 name,
...
AS
 SELECT mysql_database.mysql_host_id,
        mysql_database.database_date,
        mysql_database.name,
        mysql_database.innodb_tables,
        mysql_database.myisam_tables,
        mysql_database.csv_tables
 FROM public.mysql_database
 ORDER BY mysql_database.mysql_host_id,
          mysql_database.database_date,
          mysql_database.name,
          mysql_database.innodb_tables,
          mysql_database.myisam_tables,
          mysql_database.csv_tables
SEGMENTED BY hash(mysql_database.mysql_host_id, mysql_database.database_date, mysql_database.innodb_tables, mysql_database.myisam_tables, mysql_database.csv_tables, mysql_database.name) ALL NODES KSAFE 1;

CREATE PROJECTION public.mysql_host_metrics /*+createtype(L)*/ 
(
 mysql_host_id,
 metrics_date,
 version,
...
AS
 SELECT mysql_host_metrics.mysql_host_id,
        mysql_host_metrics.metrics_date,
        mysql_host_metrics.version,
        mysql_host_metrics.full_text_index,
        mysql_host_metrics.geospatial,
        mysql_host_metrics.ssl,
        mysql_host_metrics.binlog_format,
        mysql_host_metrics.default_storage_engine,
        mysql_host_metrics.sql_mode
 FROM public.mysql_host_metrics
 ORDER BY mysql_host_metrics.mysql_host_id,
          mysql_host_metrics.metrics_date,
          mysql_host_metrics.version,
          mysql_host_metrics.full_text_index,
          mysql_host_metrics.geospatial,
          ...
          mysql_host_metrics.default_storage_engine,
          mysql_host_metrics.sql_mode
SEGMENTED BY hash(mysql_host_metrics.mysql_host_id, mysql_host_metrics.metrics_date, mysql_host_metrics.full_text_index, mysql_host_metrics.geospatial, mysql_host_metrics.ssl, mysql_host_metrics.version, mysql_host_metrics.binlog_format, mysql_host_metrics.default_storage_engine, mysql_host_metrics.sql_mode) ALL NODES KSAFE 1;

CREATE PROJECTION public.mysql_status_counters /*+createtype(L)*/ 
(
 mysql_host_id,
 status_date,
 Aborted_clients,
...
AS
 SELECT mysql_status_counters.mysql_host_id,
        mysql_status_counters.status_date,
        mysql_status_counters.Aborted_clients,
        mysql_status_counters.Aborted_connects,
        mysql_status_counters.Binlog_cache_disk_use,
        mysql_status_counters.Binlog_cache_use,
        mysql_status_counters.Binlog_stmt_cache_use,
        mysql_status_counters.Bytes_received,
        mysql_status_counters.Bytes_sent,
        mysql_status_counters.Com_admin_commands,
        mysql_status_counters.Com_begin,
        mysql_status_counters.Com_change_db,
        mysql_status_counters.Com_commit,
        mysql_status_counters.Com_create_db,
        mysql_status_counters.Com_create_table,
        mysql_status_counters.Com_delete,
        mysql_status_counters.Com_insert,
        mysql_status_counters.Com_insert_select,
        mysql_status_counters.Com_replace,
        mysql_status_counters.Com_replace_select,
        mysql_status_counters.Com_select,
        mysql_status_counters.Com_set_option,
        mysql_status_counters.Com_show_create_table,
        mysql_status_counters.Com_show_databases,
        mysql_status_counters.Com_show_engine_status,
        mysql_status_counters.Com_show_fields,
        mysql_status_counters.Com_show_grants,
        mysql_status_counters.Com_show_processlist,
        mysql_status_counters.Com_show_slave_status,
        mysql_status_counters.Com_show_status,
        mysql_status_counters.Com_show_tables,
        mysql_status_counters.Com_show_variables,
        mysql_status_counters.Com_truncate,
        mysql_status_counters.Com_update,
        mysql_status_counters.Connections,
        mysql_status_counters.Created_tmp_disk_tables,
        mysql_status_counters.Created_tmp_tables,
        mysql_status_counters.Handler_commit,
        mysql_status_counters.Handler_delete,
        mysql_status_counters.Handler_external_lock,
        mysql_status_counters.Handler_prepare,
        mysql_status_counters.Handler_read_first,
        mysql_status_counters.Handler_read_key,
        mysql_status_counters.Handler_read_next,
        mysql_status_counters.Handler_read_rnd,
        mysql_status_counters.Handler_read_rnd_next,
        mysql_status_counters.Handler_update,
        mysql_status_counters.Handler_write,
        mysql_status_counters.Innodb_buffer_pool_bytes_data,
        mysql_status_counters.Innodb_buffer_pool_pages_flushed,
        mysql_status_counters.Innodb_buffer_pool_read_ahead,
        mysql_status_counters.Innodb_buffer_pool_read_ahead_evicted,
        mysql_status_counters.Innodb_buffer_pool_read_requests,
        mysql_status_counters.Innodb_buffer_pool_reads,
        mysql_status_counters.Innodb_buffer_pool_write_requests,
        mysql_status_counters.Innodb_data_fsyncs,
        mysql_status_counters.Innodb_data_read,
        mysql_status_counters.Innodb_data_reads,
        mysql_status_counters.Innodb_data_writes,
        mysql_status_counters.Innodb_data_written,
        mysql_status_counters.Innodb_dblwr_pages_written,
        mysql_status_counters.Innodb_dblwr_writes,
        mysql_status_counters.Innodb_log_write_requests,
        mysql_status_counters.Innodb_log_writes,
        mysql_status_counters.Innodb_os_log_fsyncs,
        mysql_status_counters.Innodb_os_log_written,
        mysql_status_counters.Innodb_pages_created,
        mysql_status_counters.Innodb_pages_read,
        mysql_status_counters.Innodb_pages_written,
        mysql_status_counters.Innodb_rows_deleted,
        mysql_status_counters.Innodb_rows_inserted,
        mysql_status_counters.Innodb_rows_read,
        mysql_status_counters.Innodb_rows_updated,
        mysql_status_counters.Innodb_num_open_files,
        mysql_status_counters.Innodb_available_undo_logs,
        mysql_status_counters.Key_read_requests,
        mysql_status_counters.Key_reads,
        mysql_status_counters.Key_write_requests,
        mysql_status_counters.Key_writes,
        mysql_status_counters.Open_table_definitions,
        mysql_status_counters.Opened_files,
        mysql_status_counters.Opened_table_definitions,
        mysql_status_counters.Opened_tables,
        mysql_status_counters.Queries,
        mysql_status_counters.Questions,
        mysql_status_counters.Select_range,
        mysql_status_counters.Select_scan,
        mysql_status_counters.Slow_queries,
        mysql_status_counters.Sort_rows,
        mysql_status_counters.Sort_scan,
        mysql_status_counters.Table_locks_immediate,
        mysql_status_counters.Table_open_cache_hits,
        mysql_status_counters.Table_open_cache_misses,
        mysql_status_counters.Uptime
 FROM public.mysql_status_counters
 ORDER BY mysql_status_counters.mysql_host_id,
          mysql_status_counters.status_date,
          mysql_status_counters.Aborted_clients,
          mysql_status_counters.Aborted_connects,
          mysql_status_counters.Binlog_cache_disk_use,
          ...
          mysql_status_counters.Table_open_cache_misses,
          mysql_status_counters.Uptime
SEGMENTED BY hash(mysql_status_counters.mysql_host_id, mysql_status_counters.status_date, mysql_status_counters.Aborted_clients, mysql_status_counters.Aborted_connects, mysql_status_counters.Binlog_cache_disk_use, mysql_status_counters.Binlog_cache_use, mysql_status_counters.Binlog_stmt_cache_use, mysql_status_counters.Bytes_received, mysql_status_counters.Bytes_sent, mysql_status_counters.Com_admin_commands, mysql_status_counters.Com_begin, mysql_status_counters.Com_change_db, mysql_status_counters.Com_commit, mysql_status_counters.Com_create_db, mysql_status_counters.Com_create_table, mysql_status_counters.Com_delete, mysql_status_counters.Com_insert, mysql_status_counters.Com_insert_select, mysql_status_counters.Com_replace, mysql_status_counters.Com_replace_select, mysql_status_counters.Com_select, mysql_status_counters.Com_set_option, mysql_status_counters.Com_show_create_table, mysql_status_counters.Com_show_databases, mysql_status_counters.Com_show_engine_status, mysql_status_counters.Com_show_fields, mysql_status_counters.Com_show_grants, mysql_status_counters.Com_show_processlist, mysql_status_counters.Com_show_slave_status, mysql_status_counters.Com_show_status, mysql_status_counters.Com_show_tables, mysql_status_counters.Com_show_variables) ALL NODES KSAFE 1;

CREATE PROJECTION public.mysql_system /*+createtype(L)*/ 
(
 mysql_host_id,
 system_type,
 system_os,
...
AS
 SELECT mysql_system.mysql_host_id,
        mysql_system.system_type,
        mysql_system.system_os,
        mysql_system.system_os_release,
        mysql_system.is_virtual,
        mysql_system.virtualized,
        mysql_system.processor,
        mysql_system.processor_speed,
        mysql_system.processor_model,
        mysql_system.memory,
        mysql_system.memory_free,
        mysql_system.disk_size
 FROM public.mysql_system
 ORDER BY mysql_system.mysql_host_id,
          mysql_system.system_type,
          mysql_system.system_os,
          mysql_system.system_os_release,
          mysql_system.is_virtual,
          ...
          mysql_system.memory_free,
          mysql_system.disk_size
SEGMENTED BY hash(mysql_system.mysql_host_id, mysql_system.is_virtual, mysql_system.disk_size, mysql_system.system_type, mysql_system.system_os, mysql_system.system_os_release, mysql_system.virtualized, mysql_system.processor, mysql_system.processor_speed, mysql_system.processor_model, mysql_system.memory, mysql_system.memory_free) ALL NODES KSAFE 1;

CREATE PROJECTION public.v4_submissionwise_v5_test /*+createtype(L)*/ 
(
 submission_date,
 search_provider,
 search_count,
...
AS
 SELECT v4_submissionwise_v5_test.submission_date,
        v4_submissionwise_v5_test.search_provider,
        v4_submissionwise_v5_test.search_count,
        v4_submissionwise_v5_test.country,
        v4_submissionwise_v5_test.locale,
        v4_submissionwise_v5_test.distribution_id,
        v4_submissionwise_v5_test.default_provider,
        v4_submissionwise_v5_test.profiles_matching,
        v4_submissionwise_v5_test.profile_share,
        v4_submissionwise_v5_test.intermediate_source
 FROM public.v4_submissionwise_v5_test
 ORDER BY v4_submissionwise_v5_test.submission_date,
          v4_submissionwise_v5_test.search_provider,
          v4_submissionwise_v5_test.search_count,
          v4_submissionwise_v5_test.country,
          v4_submissionwise_v5_test.locale,
